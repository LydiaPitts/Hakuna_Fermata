...
in_thread do
  4.times do
    play chord(:g, :maj9), attack: 0.25, release: 1
    sleep(1)
  end
  4.times do
    play chord(:c, :maj9), attack: 0.25, release: 1
    sleep(1)
  end
  4.times do
    play chord(:d, :maj9), attack: 0.25, release: 1
    sleep(1)
  end
...
in_thread do
  play chord(:g, :maj9), attack: 1, release: 2
  sleep 2
  play chord(:d, :maj9), attack: 1, release: 2
  sleep 2
  play chord(:c, :maj9), attack: 1, release: 2
  sleep 2
end
